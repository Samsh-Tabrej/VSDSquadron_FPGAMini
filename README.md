...
# Overview
Here is the explanation for the verilog code [ultra_sonic.v](https://github.com/Samsh-Tabrej/VSDSquadron_FPGAMini/blob/main/sensor_acquisition/ultra_sonic.v).
